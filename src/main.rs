...
use physics_reinforcement_learning_environment::{
    egui, run, Agent, Algorithm, Environment, Move, Receiver, Sender, TrainingDetails, World,
    WorldObject,
};
...
struct BruteForceSearchTrainingDetails {
    move_repeat_count: usize,
...
fn main() {
    run::<ListOfMovesAgent, BruteForceSearchNode, BruteForceSearchTrainingDetails, BruteForceSearch>(
    );
}
